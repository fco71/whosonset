...
// Minimal Task Assignment Notification
...
// Minimal Project Update Notification
export const notifyProjectUpdate = onDocumentUpdated("projects/{projectId}", async (event) => {
  console.log("Project update notification triggered");
...
// Minimal Application Status Update Notification
export const notifyApplicationStatusUpdate = onDocumentUpdated("jobApplications/{applicationId}", async (event) => {
  console.log("Application status update notification triggered");
