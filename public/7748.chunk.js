"use strict";
(self["webpackChunkwhosonset"] = self["webpackChunkwhosonset"] || []).push([[7748],{
...
const JobApplicationDashboard = () => {
    ...
    const [jobDetails, setJobDetails] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({});
    ...
    const loadApplications = async () => {
        ...
        setIsLoading(true);
        try {
            const userApplications = await _utilities_jobApplicationService__WEBPACK_IMPORTED_MODULE_5__/* .JobApplicationService */ .l.getUserApplications(currentUser.uid);
            ...
            for (const application of userApplications) {
                if (application.jobId) {
                    try {
                        const jobDoc = await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.getDoc)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.doc)(_firebase__WEBPACK_IMPORTED_MODULE_3__.db, 'jobPostings', application.jobId));
                        if (jobDoc.exists()) {
    ...
    const handleDeleteApplication = async (applicationId) => {
        ...
        try {
            await _utilities_jobApplicationService__WEBPACK_IMPORTED_MODULE_5__/* .JobApplicationService */ .l.deleteApplication(applicationId);
            ...
            react_hot_toast__WEBPACK_IMPORTED_MODULE_4__/* .toast */ .oR.error('Failed to withdraw application');
        }
    };
...
//# sourceMappingURL=7748.chunk.js.map