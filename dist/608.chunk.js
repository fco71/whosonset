"use strict";
(self["webpackChunkwhosonset"] = self["webpackChunkwhosonset"] || []).push([[608],{
...
const SavedCrewProfilesPage = () => {
    ...
    if (loading) {
        return ((0,jsx_runtime.jsxs)("div", { className: "min-h-screen bg-white", children: [(0,jsx_runtime.jsx)("div", { className: "bg-gradient-to-br from-gray-50 to-white border-b border-gray-100", children: (0,jsx_runtime.jsx)("div", { className: "max-w-7xl mx-auto px-8 py-24", children: (0,jsx_runtime.jsxs)("div", { className: "text-center mb-16 animate-fade-in", children: [(0,jsx_runtime.jsx)("h1", { className: "text-6xl font-light text-gray-900 mb-6 tracking-tight animate-slide-up", children: "Saved" }), (0,jsx_runtime.jsx)("h2", { className: "text-4xl font-light text-gray-600 mb-8 tracking-wide animate-slide-up-delay", children: "Crew Profiles" })] }) }) }), (0,jsx_runtime.jsx)("div", { className: "max-w-7xl mx-auto px-8 py-16", children: (0,jsx_runtime.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8", children: [...Array(8)].map((_, i) => ((0,jsx_runtime.jsxs)("div", { className: "bg-white rounded-xl shadow-sm p-6 animate-pulse", children: [(0,jsx_runtime.jsx)("div", { className: "h-48 bg-gray-200 rounded-lg mb-4" }), (0,jsx_runtime.jsx)("div", { className: "h-6 bg-gray-200 rounded mb-2" }), (0,jsx_runtime.jsx)("div", { className: "h-4 bg-gray-200 rounded mb-4" }), (0,jsx_runtime.jsx)("div", { className: "h-4 bg-gray-200 rounded mb-6" }), (0,jsx_runtime.jsxs)("div", { className: "flex gap-3", children: [(0,jsx_runtime.jsx)("div", { className: "flex-1 h-10 bg-gray-200 rounded-lg" }), (0,jsx_runtime.jsx)("div", { className: "w-20 h-10 bg-gray-200 rounded-lg" })] })] }, i))) }) })] }));
    }
    return ((0,jsx_runtime.jsxs)("div", { className: "min-h-screen bg-white", children: [(0,jsx_runtime.jsx)("div", { className: "bg-gradient-to-br from-gray-50 to-white border-b border-gray-100", children: (0,jsx_runtime.jsx)("div", { className: "max-w-7xl mx-auto px-8 py-24", children: (0,jsx_runtime.jsxs)("div", { className: "text-center mb-16 animate-fade-in", children: [(0,jsx_runtime.jsx)("h1", { className: "text-6xl font-light text-gray-900 mb-6 tracking-tight animate-slide-up", children: "Saved" }), (0,jsx_runtime.jsx)("h2", { className: "text-4xl font-light text-gray-600 mb-8 tracking-wide animate-slide-up-delay", children: "Crew Profiles" }), (0,jsx_runtime.jsx)("p", { className: "text-xl font-light text-gray-500 max-w-2xl mx-auto animate-slide-up-delay-2", children: "Your curated collection of talented crew members" })] }) }) }), (0,jsx_runtime.jsx)("div", { className: "max-w-7xl mx-auto px-8 py-16", children: savedProfiles.length === 0 ? ((0,jsx_runtime.jsxs)("div", { className: "text-center py-16", children: [(0,jsx_runtime.jsx)("div", { className: "text-6xl mb-6", children: "\uD83D\uDCC1" }), (0,jsx_runtime.jsx)("h3", { className: "text-2xl font-light text-gray-900 mb-4 tracking-wide", children: "No Saved Profiles Yet" }), (0,jsx_runtime.jsx)("p", { className: "text-gray-600 font-light mb-8 max-w-md mx-auto", children: "Start building your collection by browsing crew profiles and saving the ones you're interested in." }), (0,jsx_runtime.jsx)("a", { href: "/producer-view", className: "inline-flex items-center px-6 py-3 bg-gray-900 text-white rounded-lg font-light tracking-wide hover:bg-black transition-all duration-300 hover:scale-105", children: "Browse Crew Profiles \u2192" })] })) : ((0,jsx_runtime.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8", children: savedProfiles.map((profile, index) => ((0,jsx_runtime.jsx)("div", { className: "animate-card-entrance", style: { animationDelay: `${index * 100}ms` }, children: (0,jsx_runtime.jsx)(components_CrewProfileCard, { profile: profile }) }, profile.uid))) })) })] }));
};
...
//# sourceMappingURL=608.chunk.js.map