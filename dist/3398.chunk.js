...
const ApplicationMessaging = ({ applicationId, onClose, isModal = false }) => {
    ...
    if (isModal) {
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4", onClick: onClose, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "bg-white rounded-xl max-w-2xl w-full max-h-[80vh] flex flex-col", onClick: (e) => e.stopPropagation(), children: content }) }));
    }
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_ui_Card__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Ay, { className: "h-[600px] flex flex-col", children: content }));
};
