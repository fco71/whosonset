...
const ChatInterface_ChatInterface = ({ currentUserId, currentUserName, currentUserAvatar, demoUsers = {} }) => {
    ...
    const sendPendingAttachment = (0,react.useCallback)(async () => {
        ...
        try {
            ...
            try {
                fileUrl = await messagingService/* MessagingService */.U.uploadFileToStorage(pendingAttachment, 'chat-uploads');
