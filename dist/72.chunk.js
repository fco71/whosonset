"use strict";
(self["webpackChunkwhosonset"] = self["webpackChunkwhosonset"] || []).push([[72],{
...
const TrendingUp = (0,createLucideIcon/* default */.A)("trending-up", __iconNode);
...
const Award = (0,createLucideIcon/* default */.A)("award", award_iconNode);
...
const HomePage = () => {
    const [stats, setStats] = (0,react.useState)([
        ...
        { number: "Loading...", label: "Success Rate", icon: (0,jsx_runtime.jsx)(TrendingUp, { className: "w-5 h-5" }) },
        ...
        const fetchStats = async () => {
            try {
                ...
                setStats([
                    ...
                    { number: `${successRate}%`, label: "Success Rate", icon: (0,jsx_runtime.jsx)(TrendingUp, { className: "w-5 h-5" }) },
                ...
                setStats([
                    ...
                    { number: "—", label: "Success Rate", icon: (0,jsx_runtime.jsx)(TrendingUp, { className: "w-5 h-5" }) },
