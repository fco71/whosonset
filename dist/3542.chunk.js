...
const ResumeView = (props) => {
    ...
    return ((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [(0,jsx_runtime.jsx)("style", { children: `
        ...
        ` }), (0,jsx_runtime.jsx)("div", { className: "resume-container", style: containerStyle, children: (0,jsx_runtime.jsx)("div", { style: contentWrapperStyle, children: (0,jsx_runtime.jsxs)("div", { style: scrollableContentStyle, children: [(0,jsx_runtime.jsxs)("div", { style: headerStyle, children: [managedProfileImageUrl && ((0,jsx_runtime.jsx)("img", { src: managedProfileImageUrl, alt: "Profile", style: profileImageStyle, crossOrigin: "anonymous", onError: e => (0,imageErrorFallback/* imageErrorFallback */.i)(e) })), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("h1", { style: nameStyle, children: profile.name }), profile.bio && ((0,jsx_runtime.jsx)("p", { style: bioStyle, children: profile.bio }))] })] }), profile.languages && profile.languages.length > 0 && contentLimits.find(s => s.type === 'languages') && ((0,jsx_runtime.jsxs)("section", { style: sectionStyle, children: [(0,jsx_runtime.jsx)("div", { style: sectionTitleStyle, children: t('resume.sections.languages') }), (0,jsx_runtime.jsx)("ul", { style: jobTitlesListStyle, children: profile.languages.slice(0, 2).map((lang, idx) => ((0,jsx_runtime.jsx)("li", { style: jobTitleItemStyle, children: lang }, idx))) }), profile.languages.length > 2 && ((0,jsx_runtime.jsxs)("p", { style: { fontSize: '9pt', color: '#666', fontStyle: 'italic', margin: '1mm 0 0 0' }, children: ["(", t('resume.labels.showingTop', { count: 2, type: t('resume.types.languages') }), ")"] }))] })), profile.residences && profile.residences.length > 0 && contentLimits.find(s => s.type === 'residences') && ((0,jsx_runtime.jsxs)("section", { style: sectionStyle, children: [(0,jsx_runtime.jsx)("div", { style: sectionTitleStyle, children: t('resume.sections.residences') }), (0,jsx_runtime.jsx)("ul", { style: jobTitlesListStyle, children: profile.residences.slice(0, 2).map((residence, idx) => ((0,jsx_runtime.jsx)("li", { style: jobTitleItemStyle, children: residence.city && residence.country ? `${residence.city}, ${residence.country}` :
                                            ...
                                            .map((p, i) => ((0,jsx_runtime.jsxs)("li", { style: projectItemStyle, children: [(0,jsx_runtime.jsx)("span", { style: projectNameStyle, children: p.projectName }), (0,jsx_runtime.jsxs)("span", { style: projectRoleStyle, children: [" \u2014 ", p.role] }), p.description && ((0,jsx_runtime.jsxs)("span", { style: projectDescriptionStyle, children: [": ", p.description] }))] }, i))) }), profile.projects.filter(p => p.projectName && p.role).length > 2 && ((0,jsx_runtime.jsxs)("p", { style: { fontSize: '9pt', color: '#666', fontStyle: 'italic', margin: '1mm 0 0 0' }, children: ["(", t('resume.labels.showingTop', { count: 2, type: t('resume.types.projects') }), ")"] }))] })), profile.education && profile.education.length > 0 && contentLimits.find(s => s.type === 'education') && ((0,jsx_runtime.jsxs)("div", { style: sectionStyle, children: [(0,jsx_runtime.jsx)("h2", { style: sectionTitleStyle, children: t('resume.sections.education') }), (0,jsx_runtime.jsx)("ul", { style: jobTitlesListStyle, children: profile.education
                                            .filter(edu => {
                                        ...
                                        }) }), profile.education.length > 1 && ((0,jsx_runtime.jsxs)("p", { style: { fontSize: '9pt', color: '#666', fontStyle: 'italic', margin: '1mm 0 0 0' }, children: ["(", t('resume.labels.showingMostRecent', { count: 1 }), ")"] }))] })), (profile.contactInfo?.email || profile.contactInfo?.phone || profile.contactInfo?.website || profile.contactInfo?.instagram) && ((0,jsx_runtime.jsxs)("div", { style: sectionStyle, children: [(0,jsx_runtime.jsx)("h2", { style: sectionTitleStyle, children: t('resume.sections.contactInformation') }), (0,jsx_runtime.jsxs)("ul", { style: contactListStyle, children: [profile.contactInfo.email && (0,jsx_runtime.jsxs)("li", { style: contactItemStyle, children: ["\uD83D\uDCE7 ", profile.contactInfo.email] }), profile.contactInfo.phone && (0,jsx_runtime.jsxs)("li", { style: contactItemStyle, children: ["\uD83D\uDCDE ", profile.contactInfo.phone] }), profile.contactInfo.website && (0,jsx_runtime.jsxs)("li", { style: contactItemStyle, children: ["\uD83C\uDF10 ", profile.contactInfo.website] }), profile.contactInfo.instagram && (0,jsx_runtime.jsxs)("li", { style: contactItemStyle, children: ["\uD83D\uDCF7 @", profile.contactInfo.instagram] })] })] })), profile.otherInfo && contentLimits.find(s => s.type === 'otherInfo') && ((0,jsx_runtime.jsxs)("div", { style: sectionStyle, children: [(0,jsx_runtime.jsx)("h2", { style: sectionTitleStyle, children: t('resume.sections.additionalInformation') }), (0,jsx_runtime.jsx)("p", { style: {
                                            ...otherInfoStyle,
