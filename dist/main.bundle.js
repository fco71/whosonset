...
const NotificationCenter = ({ isOpen, onClose }) => {
    ...
    return ((0,jsx_runtime.jsx)("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50", children: (0,jsx_runtime.jsxs)("div", { className: "bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] flex flex-col", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between p-6 border-b border-gray-200", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center space-x-3", children: [(0,jsx_runtime.jsx)(bell/* default */.A, { className: "w-6 h-6 text-blue-600" }), (0,jsx_runtime.jsxs)("h2", { className: "text-xl font-semibold text-gray-900", children: [t('notifications.title', 'Notifications'), unreadCount > 0 && ((0,jsx_runtime.jsx)("span", { className: "ml-2 bg-red-500 text-white text-xs px-2 py-1 rounded-full", children: unreadCount }))] })] }), (0,jsx_runtime.jsx)("button", { onClick: onClose, className: "text-gray-400 hover:text-gray-600 transition-colors", children: (0,jsx_runtime.jsx)(x/* default */.A, { className: "w-6 h-6" }) })] }), (0,jsx_runtime.jsxs)("div", { className: "p-4 border-b border-gray-200", children: [(0,jsx_runtime.jsxs)("div", { className: "flex space-x-2 mb-3", children: [(0,jsx_runtime.jsxs)("div", { className: "flex-1 relative", children: [(0,jsx_runtime.jsx)(search/* default */.A, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" }), (0,jsx_runtime.jsx)("input", { type: "text", placeholder: t('notifications.search', 'Search notifications...'), value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), className: "w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" })] }), (0,jsx_runtime.jsxs)("select", { value: filter, onChange: (e) => setFilter(e.target.value), className: "px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500", children: [(0,jsx_runtime.jsx)("option", { value: "all", children: t('notifications.all', 'All') }), (0,jsx_runtime.jsx)("option", { value: "unread", children: t('notifications.unread', 'Unread') }), (0,jsx_runtime.jsx)("option", { value: "read", children: t('notifications.read', 'Read') })] })] }), showBulkActions && selectedNotifications.length > 0 && ((0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between bg-blue-50 p-3 rounded-lg", children: [(0,jsx_runtime.jsxs)("span", { className: "text-sm text-blue-800", children: [selectedNotifications.length, " notification(s) selected"] }), (0,jsx_runtime.jsxs)("div", { className: "flex space-x-2", children: [(0,jsx_runtime.jsxs)("button", { onClick: handleBulkMarkAsRead, className: "flex items-center space-x-1 px-3 py-1 bg-green-600 text-white text-sm rounded hover:bg-green-700", children: [(0,jsx_runtime.jsx)(check/* default */.A, { className: "w-4 h-4" }), (0,jsx_runtime.jsx)("span", { children: "Mark Read" })] }), (0,jsx_runtime.jsxs)("button", { onClick: handleBulkDelete, className: "flex items-center space-x-1 px-3 py-1 bg-red-600 text-white text-sm rounded hover:bg-red-700", children: [(0,jsx_runtime.jsx)(trash_2/* default */.A, { className: "w-4 h-4" }), (0,jsx_runtime.jsx)("span", { children: "Delete" })] })] })] }))] }), (0,jsx_runtime.jsx)("div", { className: "flex-1 overflow-y-auto p-4", children: filteredNotifications.length === 0 ? ((0,jsx_runtime.jsxs)("div", { className: "text-center py-8", children: [(0,jsx_runtime.jsx)(bell/* default */.A, { className: "w-12 h-12 text-gray-400 mx-auto mb-4" }), (0,jsx_runtime.jsx)("p", { className: "text-gray-500", children: searchTerm || filter !== 'all'
                                    ...
                                    : t('notifications.empty', 'No notifications yet') })] })) : ((0,jsx_runtime.jsx)("div", { className: "space-y-3", children: filteredNotifications.map((notification) => ((0,jsx_runtime.jsx)("div", { className: `p-4 border rounded-lg transition-all hover:shadow-md ${notification.read ? 'bg-gray-50' : 'bg-white border-blue-200'} ${selectedNotifications.includes(notification.id) ? 'ring-2 ring-blue-500' : ''}`, children: (0,jsx_runtime.jsxs)("div", { className: "flex items-start space-x-3", children: [(0,jsx_runtime.jsx)("input", { type: "checkbox", checked: selectedNotifications.includes(notification.id), onChange: (e) => {
                                        ...
                                        }, className: "mt-1" }), (0,jsx_runtime.jsx)("div", { className: "flex-shrink-0", children: (0,jsx_runtime.jsx)("span", { className: "text-2xl", children: getNotificationIcon(notification.type) }) }), (0,jsx_runtime.jsx)("div", { className: "flex-1 min-w-0", children: (0,jsx_runtime.jsxs)("div", { className: "flex items-start justify-between", children: [(0,jsx_runtime.jsxs)("div", { className: "flex-1", children: [(0,jsx_runtime.jsx)("p", { className: `text-sm font-medium ${notification.read ? 'text-gray-700' : 'text-gray-900'}`, children: notification.message }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center space-x-2 mt-1", children: [(0,jsx_runtime.jsx)("span", { className: `inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getNotificationColor(notification.type)}`, children: notification.type.replace('_', ' ') }), (0,jsx_runtime.jsx)("span", { className: "text-xs text-gray-500", children: (0,formatDistanceToNow/* formatDistanceToNow */.m)(new Date(notification.timestamp?.toDate?.() || notification.timestamp), { addSuffix: true }) })] })] }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center space-x-1", children: [!notification.read && ((0,jsx_runtime.jsx)("button", { onClick: () => markAsRead(notification.id), className: "p-1 text-gray-400 hover:text-green-600 transition-colors", title: "Mark as read", children: (0,jsx_runtime.jsx)(check/* default */.A, { className: "w-4 h-4" }) })), (0,jsx_runtime.jsx)("button", { onClick: () => deleteNotification(notification.id), className: "p-1 text-gray-400 hover:text-red-600 transition-colors", title: "Delete notification", children: (0,jsx_runtime.jsx)(trash_2/* default */.A, { className: "w-4 h-4" }) })] })] }) })] }) }, notification.id))) })) }), (0,jsx_runtime.jsx)("div", { className: "p-4 border-t border-gray-200", children: (0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center space-x-4", children: [(0,jsx_runtime.jsx)("button", { onClick: handleSelectAll, className: "text-sm text-blue-600 hover:text-blue-800", children: selectedNotifications.length === filteredNotifications.length ? 'Deselect All' : 'Select All' }), selectedNotifications.length > 0 && ((0,jsx_runtime.jsxs)("span", { className: "text-sm text-gray-500", children: [selectedNotifications.length, " selected"] }))] }), (0,jsx_runtime.jsxs)("div", { className: "text-sm text-gray-500", children: [filteredNotifications.length, " notification(s)"] })] }) })] }) }));
};
/* harmony default export */ const components_NotificationCenter = (NotificationCenter);

;// ./src/utilities/userPreferencesService.ts
...
class UserPreferencesService {
    ...
    static async getUserPreferences(userId) {
        try {
            ...
            const docRef = (0,index_esm.doc)(firebase.db, this.COLLECTION_NAME, targetUserId);
    ...
    static async saveUserPreferences(preferences, userId) {
        try {
            ...
            const docRef = (0,index_esm.doc)(firebase.db, this.COLLECTION_NAME, targetUserId);
            await (0,index_esm/* setDoc */.BN)(docRef, preferences, { merge: true });
    ...
    static async updateUserPreferences(updates, userId) {
        try {
            ...
            const docRef = (0,index_esm.doc)(firebase.db, this.COLLECTION_NAME, targetUserId);
            await (0,index_esm/* updateDoc */.mZ)(docRef, updates);
    ...
    static async getUsersWithNotificationType(type, enabled = true) {
        try {
            const q = (0,index_esm/* query */.P)((0,index_esm/* collection */.rJ)(firebase.db, this.COLLECTION_NAME), (0,index_esm/* where */._M)(type, '==', enabled));
...
var smartphone = __webpack_require__(9574);
...
var save = __webpack_require__(8852);
...
const NotificationSettings = ({ isOpen, onClose }) => {
    ...
    if (!isOpen)
        return null;
    return ((0,jsx_runtime.jsx)("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50", children: (0,jsx_runtime.jsxs)("div", { className: "bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between p-6 border-b border-gray-200", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center space-x-3", children: [(0,jsx_runtime.jsx)(settings/* default */.A, { className: "w-6 h-6 text-blue-600" }), (0,jsx_runtime.jsx)("h2", { className: "text-xl font-semibold text-gray-900", children: t('notificationSettings.title', 'Notification Settings') })] }), (0,jsx_runtime.jsx)("button", { onClick: onClose, className: "text-gray-400 hover:text-gray-600 transition-colors", children: (0,jsx_runtime.jsx)(x/* default */.A, { className: "w-6 h-6" }) })] }), (0,jsx_runtime.jsx)("div", { className: "p-6", children: loading ? ((0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-center py-8", children: [(0,jsx_runtime.jsx)("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600" }), (0,jsx_runtime.jsx)("span", { className: "ml-3 text-gray-600", children: "Loading preferences..." })] })) : error ? ((0,jsx_runtime.jsxs)("div", { className: "bg-red-50 border border-red-200 rounded-lg p-4 mb-4", children: [(0,jsx_runtime.jsx)("p", { className: "text-red-800", children: error }), (0,jsx_runtime.jsx)("button", { onClick: loadPreferences, className: "mt-2 text-red-600 hover:text-red-800 underline", children: "Try again" })] })) : preferences ? ((0,jsx_runtime.jsxs)("div", { className: "space-y-6", children: [success && ((0,jsx_runtime.jsxs)("div", { className: "bg-green-50 border border-green-200 rounded-lg p-4 flex items-center", children: [(0,jsx_runtime.jsx)(check/* default */.A, { className: "w-5 h-5 text-green-600 mr-2" }), (0,jsx_runtime.jsx)("span", { className: "text-green-800", children: "Settings saved successfully!" })] })), (0,jsx_runtime.jsxs)(Card/* default */.Ay, { className: "p-6", children: [(0,jsx_runtime.jsxs)("h3", { className: "text-lg font-medium text-gray-900 mb-4 flex items-center", children: [(0,jsx_runtime.jsx)(bell/* default */.A, { className: "w-5 h-5 mr-2 text-blue-600" }), t('notificationSettings.general', 'General Settings')] }), (0,jsx_runtime.jsxs)("div", { className: "space-y-4", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center space-x-3", children: [(0,jsx_runtime.jsx)(mail/* default */.A, { className: "w-5 h-5 text-gray-600" }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("p", { className: "font-medium text-gray-900", children: "Email Notifications" }), (0,jsx_runtime.jsx)("p", { className: "text-sm text-gray-500", children: "Receive notifications via email" })] })] }), (0,jsx_runtime.jsx)("button", { onClick: () => handleToggle('emailNotifications'), className: `relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${preferences.emailNotifications ? 'bg-blue-600' : 'bg-gray-200'}`, children: (0,jsx_runtime.jsx)("span", { className: `inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${preferences.emailNotifications ? 'translate-x-6' : 'translate-x-1'}` }) })] }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center space-x-3", children: [(0,jsx_runtime.jsx)(smartphone/* default */.A, { className: "w-5 h-5 text-gray-600" }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("p", { className: "font-medium text-gray-900", children: "Push Notifications" }), (0,jsx_runtime.jsx)("p", { className: "text-sm text-gray-500", children: "Receive browser push notifications" })] })] }), (0,jsx_runtime.jsx)("button", { onClick: () => handleToggle('pushNotifications'), className: `relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${preferences.pushNotifications ? 'bg-blue-600' : 'bg-gray-200'}`, children: (0,jsx_runtime.jsx)("span", { className: `inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${preferences.pushNotifications ? 'translate-x-6' : 'translate-x-1'}` }) })] }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center space-x-3", children: [(0,jsx_runtime.jsx)(clock/* default */.A, { className: "w-5 h-5 text-gray-600" }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("p", { className: "font-medium text-gray-900", children: "Notification Frequency" }), (0,jsx_runtime.jsx)("p", { className: "text-sm text-gray-500", children: "How often to receive notifications" })] })] }), (0,jsx_runtime.jsxs)("select", { value: preferences.notificationFrequency, onChange: (e) => handleFrequencyChange(e.target.value), className: "border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500", children: [(0,jsx_runtime.jsx)("option", { value: "immediate", children: "Immediate" }), (0,jsx_runtime.jsx)("option", { value: "daily", children: "Daily Digest" }), (0,jsx_runtime.jsx)("option", { value: "weekly", children: "Weekly Digest" })] })] })] })] }), (0,jsx_runtime.jsxs)(Card/* default */.Ay, { className: "p-6", children: [(0,jsx_runtime.jsx)("h3", { className: "text-lg font-medium text-gray-900 mb-4", children: t('notificationSettings.specific', 'Specific Notifications') }), (0,jsx_runtime.jsx)("div", { className: "space-y-4", children: [
                                            { key: 'jobApplicationNotifications', label: 'Job Applications', description: 'New job applications for your postings' },
                                            { key: 'projectInvitationNotifications', label: 'Project Invitations', description: 'Invitations to join projects' },
                                            { key: 'taskAssignmentNotifications', label: 'Task Assignments', description: 'New tasks assigned to you' },
                                            { key: 'messageNotifications', label: 'Messages', description: 'New messages from other users' },
                                            { key: 'projectUpdateNotifications', label: 'Project Updates', description: 'Updates to projects you\'re part of' },
                                            { key: 'applicationStatusNotifications', label: 'Application Status', description: 'Updates to your job applications' }
                                        ].map(({ key, label, description }) => ((0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [(0,jsx_runtime.jsxs)("div", { className: "flex-1", children: [(0,jsx_runtime.jsx)("p", { className: "font-medium text-gray-900", children: label }), (0,jsx_runtime.jsx)("p", { className: "text-sm text-gray-500", children: description })] }), (0,jsx_runtime.jsx)("button", { onClick: () => handleToggle(key), className: `relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${preferences[key] ? 'bg-blue-600' : 'bg-gray-200'}`, children: (0,jsx_runtime.jsx)("span", { className: `inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${preferences[key] ? 'translate-x-6' : 'translate-x-1'}` }) })] }, key))) })] }), (0,jsx_runtime.jsxs)("div", { className: "flex justify-end space-x-3 pt-4 border-t border-gray-200", children: [(0,jsx_runtime.jsx)(Button/* Button */.$, { variant: "outline", onClick: onClose, disabled: saving, children: "Cancel" }), (0,jsx_runtime.jsx)(Button/* Button */.$, { onClick: handleSave, disabled: saving, className: "flex items-center space-x-2", children: saving ? ((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [(0,jsx_runtime.jsx)("div", { className: "animate-spin rounded-full h-4 w-4 border-b-2 border-white" }), (0,jsx_runtime.jsx)("span", { children: "Saving..." })] })) : ((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [(0,jsx_runtime.jsx)(save/* default */.A, { className: "w-4 h-4" }), (0,jsx_runtime.jsx)("span", { children: "Save Settings" })] })) })] })] })) : null })] }) }));
};
...
const SocialPage = react.lazy(() => Promise.all(/* import() */[__webpack_require__.e(856), __webpack_require__.e(9505), __webpack_require__.e(758), __webpack_require__.e(5091)]).then(__webpack_require__.bind(__webpack_require__, 5091)));
...
const JobsPage = react.lazy(() => __webpack_require__.e(/* import() */ 7737).then(__webpack_require__.bind(__webpack_require__, 7737)));
...
const ApplicationDashboard = react.lazy(() => Promise.all(/* import() */[__webpack_require__.e(3934), __webpack_require__.e(6093), __webpack_require__.e(3029)]).then(__webpack_require__.bind(__webpack_require__, 3029)));
...
const ProjectsPage = react.lazy(() => Promise.all(/* import() */[__webpack_require__.e(6901), __webpack_require__.e(1263)]).then(__webpack_require__.bind(__webpack_require__, 1263)));
...
/******/ __webpack_require__.O(0, [1578,7070,753,7043,1278], () => (__webpack_exec__(523)));
