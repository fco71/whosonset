...
const AuthProvider = ({ children }) => {
    ...
    const sendEmailVerificationToUser = async () => {
        ...
        await (0,firebase_auth__WEBPACK_IMPORTED_MODULE_3__/* .sendEmailVerification */ .gA)(currentUser);
        console.log('[AuthContext] Email verification sent');
    };
    const sendPasswordReset = async (email) => {
        await (0,firebase_auth__WEBPACK_IMPORTED_MODULE_3__/* .sendPasswordResetEmail */ .J1)(_firebase__WEBPACK_IMPORTED_MODULE_2__/* .auth */ .j2, email);
...
const ADSENSE_CONFIG = {
    client: "MISSING_ENV_VAR".REACT_APP_ADSENSE_CLIENT_ID || 'ca-pub-9402509441119301', // Your real AdSense client ID
    enabled: "MISSING_ENV_VAR".REACT_APP_ADSENSE_ENABLED === 'true' || "production" === 'development',
...
const AD_PLACEMENTS = [
    ...
    // Fallback display ads - only show one per position
    {
        ...
        enabled: (!ADSENSE_CONFIG.enabled || "production" === 'development') && false, // Disabled to prevent duplicates
        priority: 90,
    },
    {
...
const NotificationSettings = ({ isOpen = false, onClose }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await (0,index_esm/* setDoc */.BN)((0,index_esm.doc)(firebase.db, 'users', currentUser.uid), {
...
function AppContent() {
    ...
    const { currentPagePlacements, trackAdEvent } = (0,AdProvider/* useAds */.gA)();
...
function App() {
    return ((0,jsx_runtime.jsx)(ThemeProvider/* ThemeProvider */.NP, { children: (0,jsx_runtime.jsx)(AdProvider/* AdProvider */.PX, { children: (0,jsx_runtime.jsx)(AppContent, {}) }) }));
}
...
const ProducerView = react.lazy(() => Promise.all(/* import() */[__webpack_require__.e(856), __webpack_require__.e(6354), __webpack_require__.e(9505), __webpack_require__.e(786)]).then(__webpack_require__.bind(__webpack_require__, 786)));
...
const PublicResumePage = react.lazy(() => Promise.all(/* import() */[__webpack_require__.e(3833), __webpack_require__.e(9505), __webpack_require__.e(3542), __webpack_require__.e(2494)]).then(__webpack_require__.bind(__webpack_require__, 2494)));
...
const ApplicationDetailPage = react.lazy(() => Promise.all(/* import() */[__webpack_require__.e(5295), __webpack_require__.e(4368), __webpack_require__.e(3398), __webpack_require__.e(4567)]).then(__webpack_require__.bind(__webpack_require__, 4567)));
...
const JobApplicantsPage = react.lazy(() => Promise.all(/* import() */[__webpack_require__.e(5295), __webpack_require__.e(856), __webpack_require__.e(4368), __webpack_require__.e(3398), __webpack_require__.e(9662)]).then(__webpack_require__.bind(__webpack_require__, 9662)));
...
const AboutPage = react.lazy(() => __webpack_require__.e(/* import() */ 4863).then(__webpack_require__.bind(__webpack_require__, 4863)));
const PublicCrewPage = react.lazy(() => __webpack_require__.e(/* import() */ 1132).then(__webpack_require__.bind(__webpack_require__, 1132)));
    ...
    return (0,dist/* createBrowserRouter */.Ys)([
        {
            ...
            children: [
                ...
                {
                    path: 'about',
                    element: (0,jsx_runtime.jsx)(AboutPage, {})
                },
                {
                    path: 'crew',
                ...
                {
                    path: 'crew-public',
                    element: (0,jsx_runtime.jsx)(PublicCrewPage, {})
                },
                {
                    path: 'projects',
