...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.ad-manager{width:100%}.ad-manager .ad-placements-header{position:relative;z-index:10;background:rgba(0,0,0,0);border-bottom:none;padding:1rem 0}.ad-manager .ad-placements-header .ad-placement{margin:0}.ad-manager .ad-placements-content{margin:2rem 0}.ad-manager .ad-placements-content .ad-placement{margin:1.5rem 0}.ad-manager .ad-placements-sidebar .ad-placement{margin:1rem 0}.ad-manager .ad-placements-sidebar .ad-placement:first-child{margin-top:0}.ad-manager .ad-placements-inline .ad-placement{margin:1rem 0;display:inline-block;width:100%}.ad-manager .ad-placements-footer{margin-top:2rem;padding-top:1rem;border-top:1px solid #f0f0f0;background:rgba(0,0,0,0)}.ad-manager .ad-placements-footer .ad-placement{margin:1rem 0}.ad-manager .ad-placements-footer .ad-placement:last-child{margin-bottom:0}@media(max-width: 768px){.ad-manager .ad-placements-header{padding:.25rem 0}.ad-manager .ad-placements-content{margin:1rem 0}.ad-manager .ad-placements-content .ad-placement{margin:1rem 0}.ad-manager .ad-placements-sidebar .ad-placement{margin:.5rem 0}.ad-manager .ad-placements-inline .ad-placement{margin:.5rem 0}.ad-manager .ad-placements-footer{margin-top:1rem;padding-top:.5rem}.ad-manager .ad-placements-footer .ad-placement{margin:.5rem 0}}@media(prefers-color-scheme: dark){.ad-manager .ad-placements-header{background:rgba(0,0,0,0);border-bottom-color:#4a5568}.ad-manager .ad-placements-footer{border-top-color:#4a5568}}`, "",{"version":3,"sources":["webpack://./src/components/Ads/AdManager.scss"],"names":[],"mappings":"AAAA,YACE,UAAA,CAGA,kCACE,iBAAA,CACA,UAAA,CACA,wBAAA,CACA,kBAAA,CACA,cAAA,CAEA,gDACE,QAAA,CAKJ,mCACE,aAAA,CAEA,iDACE,eAAA,CAMF,iDACE,aAAA,CAEA,6DACE,YAAA,CAOJ,gDACE,aAAA,CACA,oBAAA,CACA,UAAA,CAKJ,kCACE,eAAA,CACA,gBAAA,CACA,4BAAA,CACA,wBAAA,CAEA,gDACE,aAAA,CAEA,2DACE,eAAA,CAMN,yBACE,kCACE,gBAAA,CAGF,mCACE,aAAA,CAEA,iDACE,aAAA,CAKF,iDACE,cAAA,CAKF,gDACE,cAAA,CAIJ,kCACE,eAAA,CACA,iBAAA,CAEA,gDACE,cAAA,CAAA,CAMN,mCACE,kCACE,wBAAA,CACA,2BAAA,CAGF,kCACE,wBAAA,CAAA","sourcesContent":[".ad-manager {\n  width: 100%;\n  \n  // Header placements\n  .ad-placements-header {\n    position: relative;\n    z-index: 10;\n    background: transparent;\n    border-bottom: none;\n    padding: 1rem 0;\n    \n    .ad-placement {\n      margin: 0;\n    }\n  }\n\n  // Content placements\n  .ad-placements-content {\n    margin: 2rem 0;\n    \n    .ad-placement {\n      margin: 1.5rem 0;\n    }\n  }\n\n  // Sidebar placements\n  .ad-placements-sidebar {\n    .ad-placement {\n      margin: 1rem 0;\n      \n      &:first-child {\n        margin-top: 0;\n      }\n    }\n  }\n\n  // Inline placements\n  .ad-placements-inline {\n    .ad-placement {\n      margin: 1rem 0;\n      display: inline-block;\n      width: 100%;\n    }\n  }\n\n  // Footer placements\n  .ad-placements-footer {\n    margin-top: 2rem;\n    padding-top: 1rem;\n    border-top: 1px solid #f0f0f0;\n    background: transparent;\n    \n    .ad-placement {\n      margin: 1rem 0;\n      \n      &:last-child {\n        margin-bottom: 0;\n      }\n    }\n  }\n\n  // Responsive design\n  @media (max-width: 768px) {\n    .ad-placements-header {\n      padding: 0.25rem 0;\n    }\n\n    .ad-placements-content {\n      margin: 1rem 0;\n      \n      .ad-placement {\n        margin: 1rem 0;\n      }\n    }\n\n    .ad-placements-sidebar {\n      .ad-placement {\n        margin: 0.5rem 0;\n      }\n    }\n\n    .ad-placements-inline {\n      .ad-placement {\n        margin: 0.5rem 0;\n      }\n    }\n\n    .ad-placements-footer {\n      margin-top: 1rem;\n      padding-top: 0.5rem;\n      \n      .ad-placement {\n        margin: 0.5rem 0;\n      }\n    }\n  }\n\n  // Dark mode support\n  @media (prefers-color-scheme: dark) {\n    .ad-placements-header {\n      background: transparent;\n      border-bottom-color: #4a5568;\n    }\n\n    .ad-placements-footer {\n      border-top-color: #4a5568;\n    }\n  }\n} "],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var AdManager_options = {};

AdManager_options.styleTagTransform = (styleTagTransform_default());
AdManager_options.setAttributes = (setAttributesWithoutAttributes_default());
AdManager_options.insert = insertBySelector_default().bind(null, "head");
AdManager_options.domAPI = (styleDomAPI_default());
AdManager_options.insertStyleElement = (insertStyleElement_default());

var AdManager_update = injectStylesIntoStyleTag_default()(AdManager/* default */.A, AdManager_options);
...
const AdManager_AdManager = ({ placements, className = '', onAdLoad, onAdError }) => {
    ...
    const renderPlacementsByPosition = (position) => {
        ...
        return ((0,jsx_runtime.jsx)("div", { className: `ad-placements-${position}`, children: renderPlacement(topPlacement) }));
    };
...
function AppContent() {
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "min-h-screen bg-background text-foreground", style: { fontFamily: 'Inter, sans-serif' }, children: [(0,jsx_runtime.jsxs)("div", { className: "min-h-screen bg-gray-50 text-gray-900", children: [(0,jsx_runtime.jsx)(components_Navigation, { authUser: currentUser, userSignOut: handleSignOut }), (0,jsx_runtime.jsx)("div", { className: "pt-16", children: (0,jsx_runtime.jsx)(components_Ads_AdManager, { placements: currentPagePlacements.filter(p => p.position === 'header'), onAdLoad: (placementId) => trackAdEvent(placementId, 'load'), onAdError: (placementId, error) => trackAdEvent(placementId, 'error') }) }), (0,jsx_runtime.jsx)("main", { className: "container mx-auto px-4 py-8 pt-24", children: (0,jsx_runtime.jsx)(react.Suspense, { fallback: (0,jsx_runtime.jsx)("div", { className: "flex items-center justify-center min-h-[400px]", children: (0,jsx_runtime.jsx)("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600" }) }), children: (0,jsx_runtime.jsx)(react_router_dist/* Outlet */.sv, {}) }) }), (0,jsx_runtime.jsx)(components_Ads_AdManager, { placements: currentPagePlacements.filter(p => p.position === 'footer'), onAdLoad: (placementId) => trackAdEvent(placementId, 'load'), onAdError: (placementId, error) => trackAdEvent(placementId, 'error') }), (0,jsx_runtime.jsx)(components_Footer, {})] }), (0,jsx_runtime.jsx)(react_hot_toast_dist/* Toaster */.l$, { position: "top-right", toastOptions: {
                    duration: 4000,
...
const ApplicationDetailPage = react.lazy(() => Promise.all(/* import() */[__webpack_require__.e(5295), __webpack_require__.e(5720), __webpack_require__.e(3398), __webpack_require__.e(4567)]).then(__webpack_require__.bind(__webpack_require__, 4567)));
...
const JobApplicantsPage = react.lazy(() => Promise.all(/* import() */[__webpack_require__.e(5295), __webpack_require__.e(856), __webpack_require__.e(5720), __webpack_require__.e(3398), __webpack_require__.e(9662)]).then(__webpack_require__.bind(__webpack_require__, 9662)));
...
/******/ __webpack_require__.O(0, [1578,7070,753,7043,4213], () => (__webpack_exec__(4943)));
