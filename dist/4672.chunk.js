...
class MessagingService {
    ...
    static async markMessageAsRead(messageId) {
        try {
            ...
            const messageRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_0__.doc)(_firebase__WEBPACK_IMPORTED_MODULE_1__.db, 'conversations', conversationId, 'messages', messageId);
            await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_0__/* .updateDoc */ .mZ)(messageRef, {
                isRead: true,
                status: 'read',
    ...
    static async updateMessageStatus(messageId, status) {
        try {
            ...
            if (status === 'read') {
                ...
                updateData.readAt = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_0__/* .serverTimestamp */ .O5)();
            }
            await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_0__/* .updateDoc */ .mZ)(messageRef, updateData);
