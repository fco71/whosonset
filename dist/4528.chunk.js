...
/* harmony import */ var _utilities_crewFavoritesService__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6838);
/* harmony import */ var react_firebase_hooks_auth__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6354);
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(4316);
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(7157);
...
const ProducerView = () => {
    ...
    const [user] = (0,react_firebase_hooks_auth__WEBPACK_IMPORTED_MODULE_7__/* .useAuthState */ .hD)(_firebase__WEBPACK_IMPORTED_MODULE_3__/* .auth */ .j2);
    ...
    const [favoriteCrewIds, setFavoriteCrewIds] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    // Filter states
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        const loadFavoriteCrewIds = async () => {
            if (user) {
                try {
                    const favoriteIds = await _utilities_crewFavoritesService__WEBPACK_IMPORTED_MODULE_6__/* .CrewFavoritesService */ .e.getFavoriteCrewIds();
    ...
    const handleCrewBookmark = async (crewId, isBookmarked) => {
        ...
        try {
            ...
            if (!crewProfile)
                return;
            if (isBookmarked) {
                await _utilities_crewFavoritesService__WEBPACK_IMPORTED_MODULE_6__/* .CrewFavoritesService */ .e.addToFavorites(crewId, {
                ...
                await _utilities_crewFavoritesService__WEBPACK_IMPORTED_MODULE_6__/* .CrewFavoritesService */ .e.removeFromFavorites(crewId);
...
const CrewProfileCard = ({ profile, index, isFiltering, currentUserId, isBookmarked, onBookmarkToggle }) => {
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: `group bg-white rounded-2xl p-8 hover:shadow-2xl transition-all duration-700 cursor-pointer border border-gray-100 hover:border-gray-200 animate-card-entrance relative`, style: {
            animationDelay: `${index * 100}ms`,
            transform: isFiltering ? 'scale(0.95) opacity(0.5)' : 'scale(1) opacity(1)',
            transition: 'all 0.5s cubic-bezier(0.4, 0, 0.2, 1)'
        }, children: [currentUserId && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { onClick: handleBookmarkClick, disabled: isBookmarking, className: `absolute top-3 right-3 p-1.5 rounded-full transition-all duration-200 ${isBookmarked
                    ? 'bg-blue-500/20 hover:bg-blue-500/30 shadow-sm'
                    : 'bg-white/10 hover:bg-white/20 shadow-sm'}`, title: isBookmarked ? 'Remove from bookmarks' : 'Add to bookmarks', style: { pointerEvents: 'auto' }, children: isBookmarked ? ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(lucide_react__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, { size: 16, className: "text-blue-600 fill-current" })) : ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(lucide_react__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A, { size: 16, className: "text-gray-600 hover:text-blue-500" })) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "flex items-start gap-6 mb-6", children: [profile.profileImageUrl ? ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("img", { src: profile.profileImageUrl, alt: profile.name, className: "w-20 h-20 rounded-full object-cover transition-transform duration-300 group-hover:scale-110" })) : ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "w-20 h-20 rounded-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center transition-transform duration-300 group-hover:scale-110", children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { className: "text-2xl text-gray-500 font-light", children: profile.name.charAt(0).toUpperCase() }) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "flex-1", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("h3", { className: "text-xl font-light text-gray-900 mb-2 tracking-wide group-hover:text-black transition-all duration-300 group-hover:scale-105", children: profile.name }), primaryJob && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", { className: "text-sm font-medium text-gray-600 mb-1 tracking-wide transition-colors duration-300 group-hover:text-gray-800", children: primaryJob.title })), primaryResidence && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", { className: "text-sm font-light text-gray-500 tracking-wide transition-colors duration-300 group-hover:text-gray-600", children: ["\uD83D\uDCCD ", primaryResidence.city, ", ", primaryResidence.country] }))] })] }), profile.availability && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "mb-6", children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { className: `inline-block px-3 py-1 rounded-full text-xs font-medium tracking-wide transition-all duration-300 group-hover:scale-105 ${profile.availability === 'available'
