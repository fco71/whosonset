...
const ProducerView = () => {
    ...
    (0,react.useEffect)(() => {
        ...
        if (showFavoritesOnly) {
            filtered = filtered.filter(profile => favoriteCrewIds.includes(profile.uid));
        }
            ...
            if (sortBy === 'relevance') {
                ...
                const getRelevanceScore = (profile) => {
                    ...
                    if (profile.availability === 'available')
                        score += 50;
                    else if (profile.availability === 'soon')
                        score += 25;
                    ...
                    if (createdAt) {
                        ...
                        if (daysSinceCreation < 30)
                            score += 15; // New profiles get bonus
