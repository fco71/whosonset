...
const JobApplicationDashboard = () => {
    ...
    const loadApplications = async () => {
        ...
        setIsLoading(true);
        try {
            const userApplications = await _utilities_jobApplicationService__WEBPACK_IMPORTED_MODULE_6__/* .JobApplicationService */ .l.getUserApplications(currentUser.uid);
    ...
    const handleDeleteApplication = async (applicationId) => {
        ...
        try {
            await _utilities_jobApplicationService__WEBPACK_IMPORTED_MODULE_6__/* .JobApplicationService */ .l.deleteApplication(applicationId);
            ...
            react_hot_toast__WEBPACK_IMPORTED_MODULE_5__/* .toast */ .oR.error('Failed to withdraw application');
        }
    };
