...
var Home = function () {
    ...
    useEffect(function () {
        var fetchProjects = function () { return __awaiter(void 0, void 0, void 0, function () {
            var projectsCollectionRef, querySnapshot, projectsData, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, getDocs(projectsCollectionRef)];
                    case 2:
                        querySnapshot = _a.sent();
                        projectsData = querySnapshot.docs.map(function (doc) { return (__assign({ id: doc.id }, doc.data())); });
                        setProjects(projectsData);
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
                        console.error('Error fetching projects:', error_1.message);
                        return [3 /*break*/, 4];
