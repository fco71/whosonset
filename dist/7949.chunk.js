...
const ProjectShowcase = ({ project, userId, onEditClick }) => {
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "px-6 py-10 max-w-6xl mx-auto text-white space-y-10", children: [(0,jsx_runtime.jsxs)("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center mt-6", children: [(0,jsx_runtime.jsx)("h1", { className: "text-3xl font-bold", children: project.projectName }), (0,jsx_runtime.jsxs)("div", { className: "flex gap-2 mt-2 md:mt-0 flex-wrap", children: [(0,jsx_runtime.jsx)("span", { className: "text-xs px-2 py-1 rounded bg-blue-700 text-white", children: project.status }), project.genres?.map((genre) => ((0,jsx_runtime.jsx)("span", { className: "text-xs px-2 py-1 bg-gray-700 rounded text-white", children: genre }, genre)))] })] }), (0,jsx_runtime.jsx)("div", { className: "grid md:grid-cols-3 gap-6 items-start", children: (0,jsx_runtime.jsxs)("div", { className: "md:col-span-3 grid grid-cols-2 gap-4", children: [" ", (0,jsx_runtime.jsx)(Field, { label: "Production Company", value: project.productionCompany }), (0,jsx_runtime.jsx)(Field, { label: "Country", value: project.country }), (0,jsx_runtime.jsx)(Field, { label: "Start Date", value: project.startDate }), (0,jsx_runtime.jsx)(Field, { label: "End Date", value: project.endDate }), (0,jsx_runtime.jsx)(Field, { label: "Location", value: project.productionLocations && project.productionLocations.length > 0
                                ...
                                : 'Location not specified' })] }) }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("h2", { className: "text-xl font-semibold mb-2", children: "Logline" }), (0,jsx_runtime.jsx)("p", { className: "text-gray-300", children: project.logline })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("h2", { className: "text-xl font-semibold mb-2", children: "Synopsis" }), (0,jsx_runtime.jsx)("p", { className: "text-gray-300 whitespace-pre-line", children: project.synopsis })] }), (0,jsx_runtime.jsx)("div", { children: userId === project.ownerId ? ((0,jsx_runtime.jsx)("button", { onClick: onEditClick, className: "px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-md", children: "Edit Project" })) : ((0,jsx_runtime.jsx)("button", { onClick: handleSuggestClick, className: "px-5 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-md", children: "Suggest Update" })) })] }));
};
const Field = ({ label, value }) => ((0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("dt", { className: "text-sm font-medium text-gray-400", children: label }), (0,jsx_runtime.jsx)("dd", { className: "text-sm text-white", children: value || '—' })] }));
...
const ProjectDetail = () => {
    ...
    const [lastVisibleReview, setLastVisibleReview] = (0,react.useState)(null);
    const [prevReviewPages, setPrevReviewPages] = (0,react.useState)([]);
    const [loadingReviews, setLoadingReviews] = (0,react.useState)(false);
    ...
    const fetchReviews = async (direction = 'reset') => {
        ...
        try {
            let q;
            const reviewsCollection = (0,index_esm/* collection */.rJ)(firebase.db, 'Projects', projectId, 'Reviews');
            if (direction === 'next' && lastVisibleReview) {
                q = (0,index_esm/* query */.P)(reviewsCollection, (0,index_esm/* orderBy */.My)('createdAt', 'desc'), (0,index_esm/* startAfter */.HM)(lastVisibleReview), (0,index_esm/* limit */.AB)(REVIEWS_PER_PAGE));
            }
                ...
                q = cursorForPrevPage ? (0,index_esm/* query */.P)(reviewsCollection, (0,index_esm/* orderBy */.My)('createdAt', 'desc'), (0,index_esm/* startAfter */.HM)(cursorForPrevPage), (0,index_esm/* limit */.AB)(REVIEWS_PER_PAGE))
                    : (0,index_esm/* query */.P)(reviewsCollection, (0,index_esm/* orderBy */.My)('createdAt', 'desc'), (0,index_esm/* limit */.AB)(REVIEWS_PER_PAGE));
                setPrevReviewPages(newPrevPages);
            }
            else {
                q = (0,index_esm/* query */.P)(reviewsCollection, (0,index_esm/* orderBy */.My)('createdAt', 'desc'), (0,index_esm/* limit */.AB)(REVIEWS_PER_PAGE));
                setPrevReviewPages([]);
            }
    ...
    const reviewSection = ((0,jsx_runtime.jsxs)("section", { className: "bg-gray-800 rounded-lg p-6 mt-10", children: [(0,jsx_runtime.jsx)("h3", { className: "text-xl font-semibold text-white mb-4", children: t('projectDetail.reviews') }), loadingReviews && (0,jsx_runtime.jsx)("p", { className: "text-gray-400", children: t('projectDetail.loadingReviews') }), reviews.length === 0 && !loadingReviews ? ((0,jsx_runtime.jsx)("p", { className: "text-gray-400", children: t('projectDetail.noReviews') })) : ((0,jsx_runtime.jsx)("ul", { className: "space-y-4", children: reviews.map((r) => ((0,jsx_runtime.jsxs)("li", { className: "border-b border-gray-700 pb-4", children: [(0,jsx_runtime.jsxs)("div", { className: "flex justify-between items-center mb-2", children: [(0,jsx_runtime.jsx)("span", { className: "font-medium text-white", children: r.author }), (0,jsx_runtime.jsx)("span", { className: "text-sm text-gray-400", children: r.createdAt.toLocaleDateString() })] }), (0,jsx_runtime.jsx)("p", { className: "text-sm text-white", children: r.content })] }, r.id))) })), (0,jsx_runtime.jsxs)("div", { className: "mt-8 flex items-center justify-between gap-6", children: [(0,jsx_runtime.jsx)("button", { onClick: () => fetchReviews('prev'), disabled: loadingReviews || prevReviewPages.length <= 1, className: "px-4 py-2 rounded-md text-sm font-medium bg-gray-700 hover:bg-gray-600 text-white disabled:opacity-40", children: t('projectDetail.previous') }), (0,jsx_runtime.jsxs)("span", { className: "text-gray-400 text-sm", children: [t('projectDetail.page'), " ", prevReviewPages.length || (reviews.length > 0 ? 1 : 0)] }), (0,jsx_runtime.jsx)("button", { onClick: () => fetchReviews('next'), disabled: loadingReviews || reviews.length < REVIEWS_PER_PAGE, className: "px-4 py-2 rounded-md text-sm font-medium bg-gray-700 hover:bg-gray-600 text-white disabled:opacity-40", children: t('projectDetail.next') })] })] }));
            ...
            loading && !project ? ((0,jsx_runtime.jsx)(LoadingSpinner, {})) :
                error && !project ? ((0,jsx_runtime.jsxs)("p", { className: "text-white text-center mt-10", children: ["Error: ", error] })) :
                    project ? ((0,jsx_runtime.jsxs)("div", { className: "max-w-4xl mx-auto py-12", children: [project.coverImageUrl && ((0,jsx_runtime.jsxs)("div", { className: "mb-6 flex justify-center", children: [" ", (0,jsx_runtime.jsx)("img", { src: project.coverImageUrl, alt: `${project.projectName} ${t('projectDetail.coverAlt')}`, className: "w-64 h-auto max-h-48 object-contain rounded-md shadow-lg", onError: imageErrorFallback/* imageErrorFallback */.i })] })), (0,jsx_runtime.jsx)(components_ProjectShowcase, { project: project, userId: currentUser?.uid, 
                                ...
                                onEditClick: handleEditClick }), reviewSection, (0,jsx_runtime.jsxs)("div", { className: "mt-10 text-center", children: [" ", currentUser && currentUser.uid === project.owner_uid ? ((0,jsx_runtime.jsxs)("div", { className: "flex gap-4 justify-center", children: [(0,jsx_runtime.jsx)(react_router_dom_dist/* Link */.N_, { to: `/projects/${projectId}/manage`, className: "px-5 py-2 bg-green-600 hover:bg-green-500 text-white rounded-md transition-colors", children: t('projects.manageProject') }), (0,jsx_runtime.jsx)("button", { onClick: handleEditClick, className: "px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-md transition-colors", children: t('projects.editProject') })] })) : ((0,jsx_runtime.jsx)("button", { onClick: handleSuggestClick, className: "px-5 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-md", children: t('projects.suggestUpdate') }))] })] })) : ((0,jsx_runtime.jsx)("div", { className: "text-white text-center mt-10", children: t('projects.projectNotFound') })))] }));
};
