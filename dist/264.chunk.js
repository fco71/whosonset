"use strict";
(self["webpackChunkwhosonset"] = self["webpackChunkwhosonset"] || []).push([[264],{
...
const Award = (0,createLucideIcon/* default */.A)("award", __iconNode);
...
const Zap = (0,createLucideIcon/* default */.A)("zap", zap_iconNode);
...
const Camera = (0,createLucideIcon/* default */.A)("camera", camera_iconNode);
...
const HomePage = () => {
    const features = [
        ...
        {
            icon: (0,jsx_runtime.jsx)(Award, { className: "w-6 h-6" }),
    ...
    const stats = [
        { number: "15,000+", label: "Active Professionals", icon: (0,jsx_runtime.jsx)(users/* default */.A, { className: "w-5 h-5" }) },
        { number: "8,500+", label: "Projects Completed", icon: (0,jsx_runtime.jsx)(film/* default */.A, { className: "w-5 h-5" }) },
        { number: "95%", label: "Success Rate", icon: (0,jsx_runtime.jsx)(TrendingUp, { className: "w-5 h-5" }) },
        { number: "60+", label: "Countries", icon: (0,jsx_runtime.jsx)(globe/* default */.A, { className: "w-5 h-5" }) }
    ];
    const testimonials = [
        {
            name: "Sarah Johnson",
...
//# sourceMappingURL=264.chunk.js.map