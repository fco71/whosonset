"use strict";
(self["webpackChunkwhosonset"] = self["webpackChunkwhosonset"] || []).push([[7011],{
...
const PostJobPage = () => {
    ...
    if (!currentUser) {
        return ((0,jsx_runtime.jsx)("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 px-4", children: (0,jsx_runtime.jsxs)("div", { className: "max-w-md w-full bg-white shadow rounded-lg p-8 text-center", children: [(0,jsx_runtime.jsx)("h2", { className: "text-2xl font-bold mb-4 text-gray-900", children: t('postJob.signInRequired') }), (0,jsx_runtime.jsxs)("p", { className: "text-gray-600 mb-6", children: [t('postJob.signInMessage'), " ", (0,jsx_runtime.jsx)("a", { href: "/login", className: "text-blue-600 hover:underline", children: t('postJob.signIn') }), " ", t('common.or'), " ", (0,jsx_runtime.jsx)("a", { href: "/register", className: "text-blue-600 hover:underline", children: t('postJob.register') }), " ", t('common.toContinue'), "."] })] }) }));
    }
    ...
    return ((0,jsx_runtime.jsx)("div", { className: "min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8", children: (0,jsx_runtime.jsxs)("div", { className: "max-w-4xl mx-auto", children: [(0,jsx_runtime.jsxs)("div", { className: "text-center mb-8", children: [(0,jsx_runtime.jsx)("h1", { className: "text-3xl font-bold text-gray-900", children: t('postJob.postNewJob') }), (0,jsx_runtime.jsx)("p", { className: "mt-2 text-sm text-gray-600", children: t('postJob.postJobDescription') })] }), errors.submit && ((0,jsx_runtime.jsx)("div", { className: "mb-4 p-4 bg-red-50 rounded-md", children: (0,jsx_runtime.jsx)("p", { className: "text-sm text-red-600 text-center", children: errors.submit }) })), (0,jsx_runtime.jsx)("form", { onSubmit: handleSubmit, className: "space-y-6", children: (0,jsx_runtime.jsxs)("div", { className: "bg-white shadow overflow-hidden sm:rounded-lg p-6 space-y-6", children: [(0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsxs)("label", { htmlFor: "title", className: "block text-sm font-medium text-gray-700", children: [t('postJob.jobTitle'), " *"] }), (0,jsx_runtime.jsx)(Input/* Input */.p, { id: "title", name: "title", type: "text", value: formData.title, onChange: (e) => handleChange('title', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", placeholder: t('postJob.jobTitlePlaceholder') }), errors.title && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.title })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsxs)("label", { htmlFor: "department", className: "block text-sm font-medium text-gray-700", children: [t('postJob.department'), " *"] }), (0,jsx_runtime.jsxs)("select", { id: "department", name: "department", value: formData.department, onChange: (e) => handleChange('department', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", children: [(0,jsx_runtime.jsx)("option", { value: "", children: t('postJob.selectDepartment') }), departmentOptions.map((dept) => ((0,jsx_runtime.jsx)("option", { value: dept.value, children: dept.label }, dept.value)))] }), errors.department && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.department })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsxs)("label", { htmlFor: "location", className: "block text-sm font-medium text-gray-700", children: [t('postJob.location'), " *"] }), (0,jsx_runtime.jsx)(Input/* Input */.p, { id: "location", name: "location", type: "text", value: formData.location, onChange: (e) => handleChange('location', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", placeholder: t('postJob.locationPlaceholder') }), errors.location && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.location })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("label", { htmlFor: "jobType", className: "block text-sm font-medium text-gray-700", children: t('postJob.jobType') }), (0,jsx_runtime.jsxs)("select", { id: "jobType", name: "jobType", value: formData.jobType, onChange: (e) => handleChange('jobType', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", children: [(0,jsx_runtime.jsx)("option", { value: "", children: t('postJob.selectJobType') }), (0,jsx_runtime.jsx)("option", { value: "full_time", children: t('postJob.fullTime') }), (0,jsx_runtime.jsx)("option", { value: "part_time", children: t('postJob.partTime') }), (0,jsx_runtime.jsx)("option", { value: "contract", children: t('postJob.contract') }), (0,jsx_runtime.jsx)("option", { value: "freelance", children: t('postJob.freelance') })] })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsxs)("label", { htmlFor: "description", className: "block text-sm font-medium text-gray-700", children: [t('postJob.jobDescription'), " *"] }), (0,jsx_runtime.jsx)(Textarea, { id: "description", name: "description", rows: 4, value: formData.description, onChange: (e) => handleChange('description', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", placeholder: t('postJob.jobDescriptionPlaceholder') }), errors.description && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.description })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("label", { htmlFor: "requirements", className: "block text-sm font-medium text-gray-700", children: t('postJob.requirements') }), (0,jsx_runtime.jsx)(Textarea, { id: "requirements", name: "requirements", rows: 3, value: formData.requirements, onChange: (e) => handleChange('requirements', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", placeholder: t('postJob.requirementsPlaceholder') }), errors.requirements && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.requirements })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("label", { htmlFor: "responsibilities", className: "block text-sm font-medium text-gray-700", children: t('postJob.responsibilities') }), (0,jsx_runtime.jsx)(Textarea, { id: "responsibilities", name: "responsibilities", rows: 3, value: formData.responsibilities, onChange: (e) => handleChange('responsibilities', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", placeholder: t('postJob.responsibilitiesPlaceholder') }), errors.responsibilities && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.responsibilities })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsxs)("label", { htmlFor: "benefits", className: "block text-sm font-medium text-gray-700", children: [t('postJob.benefits'), " & ", t('postJob.perks')] }), (0,jsx_runtime.jsx)(Textarea, { id: "benefits", name: "benefits", rows: 3, value: formData.benefits, onChange: (e) => handleChange('benefits', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", placeholder: t('postJob.benefitsPlaceholder') }), errors.benefits && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.benefits })] }), (0,jsx_runtime.jsxs)("fieldset", { className: "border border-gray-200 rounded-md p-4 mb-4", children: [(0,jsx_runtime.jsx)("legend", { className: "text-base font-medium text-gray-900 px-2", children: t('postJob.compensation') }), (0,jsx_runtime.jsxs)("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2", children: [(0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("label", { htmlFor: "salaryMin", className: "block text-sm font-medium text-gray-700", children: t('postJob.minimumSalary') }), (0,jsx_runtime.jsx)(Input/* Input */.p, { id: "salaryMin", name: "salaryMin", type: "number", min: "0", value: formData.salaryMin, onChange: e => handleChange('salaryMin', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", placeholder: t('postJob.minimumSalaryPlaceholder') }), errors.salaryMin && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.salaryMin })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("label", { htmlFor: "salaryMax", className: "block text-sm font-medium text-gray-700", children: t('postJob.maximumSalary') }), (0,jsx_runtime.jsx)(Input/* Input */.p, { id: "salaryMax", name: "salaryMax", type: "number", min: "0", value: formData.salaryMax, onChange: e => handleChange('salaryMax', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", placeholder: t('postJob.maximumSalaryPlaceholder') }), errors.salaryMax && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.salaryMax })] }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("label", { htmlFor: "salaryPeriod", className: "block text-sm font-medium text-gray-700", children: t('postJob.salaryPeriod') }), (0,jsx_runtime.jsxs)("select", { id: "salaryPeriod", name: "salaryPeriod", value: formData.salaryPeriod, onChange: e => handleChange('salaryPeriod', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm", children: [(0,jsx_runtime.jsx)("option", { value: "year", children: t('postJob.perYear') }), (0,jsx_runtime.jsx)("option", { value: "month", children: t('postJob.perMonth') }), (0,jsx_runtime.jsx)("option", { value: "week", children: t('postJob.perWeek') }), (0,jsx_runtime.jsx)("option", { value: "day", children: t('postJob.perDay') }), (0,jsx_runtime.jsx)("option", { value: "hour", children: t('postJob.perHour') })] })] }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center mt-6", children: [(0,jsx_runtime.jsx)("input", { id: "showSalary", name: "showSalary", type: "checkbox", checked: formData.showSalary, onChange: e => handleChange('showSalary', e.target.checked), className: "h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" }), (0,jsx_runtime.jsx)("label", { htmlFor: "showSalary", className: "ml-2 block text-sm text-gray-700", children: t('postJob.showSalaryOnJobPosting') })] })] })] }), (0,jsx_runtime.jsx)("div", { className: "grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2", children: (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsxs)("label", { htmlFor: "startDate", className: "block text-sm font-medium text-gray-700", children: [t('postJob.startDate'), " *"] }), (0,jsx_runtime.jsx)(Input/* Input */.p, { type: "date", name: "startDate", id: "startDate", value: formData.startDate, min: new Date().toISOString().split('T')[0], onChange: (e) => handleChange('startDate', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" }), errors.startDate && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.startDate })] }) }), (0,jsx_runtime.jsxs)("div", { className: "pt-4 border-t border-gray-200", children: [(0,jsx_runtime.jsx)("h3", { className: "text-lg font-medium text-gray-900", children: t('postJob.contactInformation') }), (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-gray-500", children: t('postJob.howToContact') }), (0,jsx_runtime.jsxs)("div", { className: "mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6", children: [(0,jsx_runtime.jsxs)("div", { className: "sm:col-span-3", children: [(0,jsx_runtime.jsxs)("label", { htmlFor: "contactName", className: "block text-sm font-medium text-gray-700", children: [t('postJob.contactName'), " *"] }), (0,jsx_runtime.jsx)(Input/* Input */.p, { type: "text", name: "contactName", id: "contactName", value: formData.contactName, onChange: (e) => handleChange('contactName', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" }), errors.contactName && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.contactName })] }), (0,jsx_runtime.jsxs)("div", { className: "sm:col-span-3", children: [(0,jsx_runtime.jsxs)("label", { htmlFor: "contactEmail", className: "block text-sm font-medium text-gray-700", children: [t('postJob.contactEmail'), " *"] }), (0,jsx_runtime.jsx)(Input/* Input */.p, { type: "email", name: "contactEmail", id: "contactEmail", value: formData.contactEmail, onChange: (e) => handleChange('contactEmail', e.target.value), className: "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" }), errors.contactEmail && (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-red-600", children: errors.contactEmail })] })] }), (0,jsx_runtime.jsxs)("div", { className: "mt-4", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center", children: [(0,jsx_runtime.jsx)("input", { id: "showContactEmail", name: "showContactEmail", type: "checkbox", checked: formData.showContactEmail, onChange: (e) => handleChange('showContactEmail', e.target.checked), className: "h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" }), (0,jsx_runtime.jsx)("label", { htmlFor: "showContactEmail", className: "ml-2 block text-sm text-gray-700", children: t('postJob.showEmailOnJobPosting') })] }), (0,jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-gray-500", children: t('postJob.showEmailExplanation') })] })] }), (0,jsx_runtime.jsxs)("div", { className: "pt-5", children: [(0,jsx_runtime.jsxs)("div", { className: "flex justify-end", children: [(0,jsx_runtime.jsx)(Button/* Button */.$, { type: "button", onClick: () => navigate(-1), className: "bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500", children: t('postJob.cancel') }), (0,jsx_runtime.jsx)(Button/* Button */.$, { type: "submit", disabled: isSubmitting || !formData.title || !formData.department || !formData.location || !formData.description || !formData.contactName || !formData.contactEmail, className: "ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200", children: isSubmitting ? ((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [(0,jsx_runtime.jsxs)("svg", { className: "animate-spin -ml-1 mr-2 h-4 w-4 text-white", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [(0,jsx_runtime.jsx)("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), (0,jsx_runtime.jsx)("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] }), t('postJob.publishing')] })) : t('postJob.publishJob') })] }), Object.keys(errors).length > 0 && ((0,jsx_runtime.jsx)("div", { className: "mt-4 p-3 bg-red-50 rounded-md", children: (0,jsx_runtime.jsx)("p", { className: "text-sm text-red-600", children: t('postJob.fixErrors') }) }))] })] }) })] }) }));
};
...
//# sourceMappingURL=7011.chunk.js.map