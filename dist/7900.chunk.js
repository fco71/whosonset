...
const JobCard = ({ job, currentUserId, onEdit }) => {
    ...
    const handleSave = async (e) => {
        ...
        if (!job.id) {
            dist/* toast */.oR.error('Invalid job data');
            return;
        }
        if (isSaving)
    ...
    return ((0,jsx_runtime.jsx)(Card/* default */.Ay, { variant: "elevated", hoverable: true, className: "group cursor-pointer overflow-hidden", onClick: () => navigate(`/jobs/${job.id}`), onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false), children: (0,jsx_runtime.jsxs)(Card/* CardBody */.bw, { className: "p-6", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-start justify-between mb-4", children: [(0,jsx_runtime.jsxs)("div", { className: "flex-1", children: [(0,jsx_runtime.jsx)(Card/* CardTitle */.ZB, { className: "text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors mb-2", children: job.title || 'Untitled Position' }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-4 text-sm text-gray-600 mb-3", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-1", children: [(0,jsx_runtime.jsx)(building/* default */.A, { className: "w-4 h-4" }), (0,jsx_runtime.jsx)("span", { children: job.department || 'Various' })] }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-1", children: [(0,jsx_runtime.jsx)(map_pin/* default */.A, { className: "w-4 h-4" }), (0,jsx_runtime.jsx)("span", { children: job.location })] }), job.isRemote && ((0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-1 text-blue-600", children: [(0,jsx_runtime.jsx)(globe/* default */.A, { className: "w-4 h-4" }), (0,jsx_runtime.jsx)("span", { children: "Remote" })] }))] })] }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-2", children: [currentUser && ((0,jsx_runtime.jsx)("button", { className: `p-2 rounded-lg transition-colors ${isSaving ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-100"} ${isSaved
...
function JobsPage() {
    ...
    const stats = [
        ...
        { icon: (0,jsx_runtime.jsx)(building/* default */.A, { className: "w-5 h-5" }), label: 'Companies', value: new Set(jobs.map(j => j.contactName || j.projectName)).size },
