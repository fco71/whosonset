...
const CollaborativeTasksHub_CollaborativeTasksHub = ({ projectId }) => {
    ...
    const handleCreateTask = async (taskData) => {
        try {
            ...
            if (!currentUser) {
                dist/* toast */.oR.error(t('tasks.errors.loginRequired'));
                return;
            }
            const newTask = {
                id: Date.now().toString(),
            ...
            dist/* toast */.oR.error(t('tasks.errors.createFailed'));
        }
    };
    const handleUpdateTask = async (taskId, updates) => {
        try {
            ...
            dist/* toast */.oR.error(t('tasks.errors.updateFailed'));
        }
    };
    const handleDeleteTask = async (taskId) => {
        if (window.confirm('Are you sure you want to delete this task?')) {
            try {
                ...
                dist/* toast */.oR.error(t('tasks.errors.deleteFailed'));
            }
        }
    };
    const handleCompleteTask = async (taskId) => {
        try {
            ...
            dist/* toast */.oR.error(t('tasks.errors.completeFailed'));
        }
    };
    const handleStartTask = async (taskId) => {
        try {
            ...
            dist/* toast */.oR.error(t('tasks.errors.startFailed'));
        }
    };
    ...
    const handleRestoreTask = async (taskId) => {
        try {
            ...
            dist/* toast */.oR.error(t('tasks.errors.restoreFailed'));
        }
    };
    const handleAddComment = async (taskId) => {
        ...
        try {
            ...
            dist/* toast */.oR.error(t('tasks.errors.commentFailed'));
        }
    };
    ...
    if (loading) {
        return ((0,jsx_runtime.jsx)("div", { className: "collaborative-tasks-hub", children: (0,jsx_runtime.jsxs)("div", { className: "loading-state", children: [(0,jsx_runtime.jsx)("div", { className: "loading-spinner" }), (0,jsx_runtime.jsx)("p", { children: t('tasks.loading') })] }) }));
    }
    return ((0,jsx_runtime.jsxs)("div", { className: "collaborative-tasks-hub", children: [(0,jsx_runtime.jsxs)("div", { className: "tasks-header", children: [(0,jsx_runtime.jsxs)("div", { className: "header-content", children: [(0,jsx_runtime.jsxs)("div", { className: "header-left", children: [(0,jsx_runtime.jsx)("h1", { className: "header-title", children: t('tasks.title') }), (0,jsx_runtime.jsx)("p", { className: "header-subtitle", children: t('tasks.subtitle') })] }), (0,jsx_runtime.jsx)("div", { className: "header-actions", children: (0,jsx_runtime.jsxs)("button", { onClick: () => {
                                        setEditingTask(null);
                                        setShowTaskForm(true);
                                    }, className: "btn-primary", children: [(0,jsx_runtime.jsx)("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 6v6m0 0v6m0-6h6m-6 0H6" }) }), t('tasks.createTask')] }) })] }), (0,jsx_runtime.jsxs)("div", { className: "stats-grid", children: [(0,jsx_runtime.jsxs)("div", { className: "stat-card", children: [(0,jsx_runtime.jsx)("div", { className: "stat-icon total", children: (0,jsx_runtime.jsx)("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" }) }) }), (0,jsx_runtime.jsxs)("div", { className: "stat-content", children: [(0,jsx_runtime.jsx)("p", { className: "stat-label", children: t('tasks.stats.total') }), (0,jsx_runtime.jsx)("p", { className: "stat-value", children: stats.total })] })] }), (0,jsx_runtime.jsxs)("div", { className: "stat-card", children: [(0,jsx_runtime.jsx)("div", { className: "stat-icon completed", children: (0,jsx_runtime.jsx)("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }), (0,jsx_runtime.jsxs)("div", { className: "stat-content", children: [(0,jsx_runtime.jsx)("p", { className: "stat-label", children: t('tasks.stats.completed') }), (0,jsx_runtime.jsx)("p", { className: "stat-value", children: stats.completed })] })] }), (0,jsx_runtime.jsxs)("div", { className: "stat-card", children: [(0,jsx_runtime.jsx)("div", { className: "stat-icon in-progress", children: (0,jsx_runtime.jsx)("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" }) }) }), (0,jsx_runtime.jsxs)("div", { className: "stat-content", children: [(0,jsx_runtime.jsx)("p", { className: "stat-label", children: t('tasks.stats.inProgress') }), (0,jsx_runtime.jsx)("p", { className: "stat-value", children: stats.inProgress })] })] }), (0,jsx_runtime.jsxs)("div", { className: "stat-card", children: [(0,jsx_runtime.jsx)("div", { className: "stat-icon overdue", children: (0,jsx_runtime.jsx)("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }) }) }), (0,jsx_runtime.jsxs)("div", { className: "stat-content", children: [(0,jsx_runtime.jsx)("p", { className: "stat-label", children: t('tasks.stats.overdue') }), (0,jsx_runtime.jsx)("p", { className: "stat-value", children: stats.overdue })] })] })] })] }), (0,jsx_runtime.jsxs)("div", { className: "tasks-controls", children: [(0,jsx_runtime.jsx)("div", { className: "controls-left", children: (0,jsx_runtime.jsxs)("div", { className: "view-mode-selector", children: [(0,jsx_runtime.jsxs)("button", { className: `view-btn ${viewMode === 'list' ? 'active' : ''}`, onClick: () => setViewMode('list'), children: [(0,jsx_runtime.jsx)("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 6h16M4 10h16M4 14h16M4 18h16" }) }), t('tasks.viewModes.list')] }), (0,jsx_runtime.jsxs)("button", { className: `view-btn ${viewMode === 'analytics' ? 'active' : ''}`, onClick: () => setViewMode('analytics'), children: [(0,jsx_runtime.jsx)("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" }) }), t('tasks.viewModes.analytics')] })] }) }), (0,jsx_runtime.jsx)("div", { className: "controls-right", children: (0,jsx_runtime.jsxs)("div", { className: "search-and-filters", children: [(0,jsx_runtime.jsx)("div", { className: "search-container", children: (0,jsx_runtime.jsxs)("div", { className: "search-box", children: [(0,jsx_runtime.jsx)("svg", { className: "w-5 h-5 search-icon", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" }) }), (0,jsx_runtime.jsx)("input", { type: "text", placeholder: t('tasks.searchTasks'), value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), className: "search-input" })] }) }), (0,jsx_runtime.jsxs)("div", { className: "filters-container", children: [(0,jsx_runtime.jsxs)("select", { value: filters.status, onChange: (e) => setFilters({ ...filters, status: e.target.value }), className: "filter-select", children: [(0,jsx_runtime.jsx)("option", { value: "all", children: t('tasks.filters.allStatus') }), (0,jsx_runtime.jsx)("option", { value: "pending", children: t('tasks.filters.pending') }), (0,jsx_runtime.jsx)("option", { value: "in_progress", children: t('tasks.filters.inProgress') }), (0,jsx_runtime.jsx)("option", { value: "completed", children: t('tasks.filters.completed') }), (0,jsx_runtime.jsx)("option", { value: "cancelled", children: t('tasks.filters.cancelled') }), (0,jsx_runtime.jsx)("option", { value: "overdue", children: t('tasks.filters.overdue') })] }), (0,jsx_runtime.jsxs)("select", { value: filters.category, onChange: (e) => setFilters({ ...filters, category: e.target.value }), className: "filter-select", children: [(0,jsx_runtime.jsx)("option", { value: "all", children: t('tasks.filters.allCategories') }), (0,jsx_runtime.jsx)("option", { value: "pre_production", children: t('tasks.categories.preProduction') }), (0,jsx_runtime.jsx)("option", { value: "production", children: t('tasks.categories.production') }), (0,jsx_runtime.jsx)("option", { value: "post_production", children: t('tasks.categories.postProduction') }), (0,jsx_runtime.jsx)("option", { value: "marketing", children: t('tasks.categories.marketing') }), (0,jsx_runtime.jsx)("option", { value: "distribution", children: t('tasks.categories.distribution') }), (0,jsx_runtime.jsx)("option", { value: "other", children: t('tasks.categories.other') })] })] })] }) })] }), (0,jsx_runtime.jsxs)("div", { className: "tasks-content", children: [viewMode === 'list' && ((0,jsx_runtime.jsx)("div", { className: "tasks-list", children: activeTasks.length === 0 ? ((0,jsx_runtime.jsxs)("div", { className: "empty-state", children: [(0,jsx_runtime.jsx)("svg", { className: "w-16 h-16 empty-icon", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" }) }), (0,jsx_runtime.jsx)("h3", { className: "empty-title", children: t('tasks.noTasks') }), (0,jsx_runtime.jsx)("p", { className: "empty-description", children: t('tasks.noTasksDescription') }), (0,jsx_runtime.jsx)("button", { onClick: () => {
                                        setEditingTask(null);
                                        setShowTaskForm(true);
                                    }, className: "btn-primary", children: t('tasks.createTask') })] })) : ((0,jsx_runtime.jsx)("div", { className: "tasks-grid", children: activeTasks.map(task => ((0,jsx_runtime.jsxs)("div", { className: `task-card ${expandedTaskId === task.id ? 'expanded' : ''}`, children: [(0,jsx_runtime.jsxs)("div", { className: "task-header", onClick: () => toggleTaskExpansion(task.id), children: [(0,jsx_runtime.jsxs)("div", { className: "task-title-section", children: [(0,jsx_runtime.jsx)("h3", { className: "task-title", children: task.title }), (0,jsx_runtime.jsx)("div", { className: "task-members", children: task.assignedTeamMembers && task.assignedTeamMembers.length > 0 ? ((0,jsx_runtime.jsxs)("div", { className: "members-avatars", children: [task.assignedTeamMembers.slice(0, 3).map((member, index) => ((0,jsx_runtime.jsx)("div", { className: "member-avatar-container", title: getMemberName(member.userId), children: getMemberAvatar(member.userId) }, member.userId))), task.assignedTeamMembers.length > 3 && ((0,jsx_runtime.jsxs)("div", { className: "member-count", title: `${task.assignedTeamMembers.length - 3} ${t('tasks.task.moreMembers')}`, children: ["+", task.assignedTeamMembers.length - 3] }))] })) : ((0,jsx_runtime.jsx)("span", { className: "no-members", children: t('tasks.task.noMembersAssigned') })) })] }), (0,jsx_runtime.jsxs)("div", { className: "task-actions", children: [(0,jsx_runtime.jsx)("span", { className: `task-status ${task.status}`, children: t(`tasks.status.${task.status}`) }), (0,jsx_runtime.jsx)("svg", { className: `expand-icon ${expandedTaskId === task.id ? 'expanded' : ''}`, fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: (0,jsx_runtime.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M19 9l-7 7-7-7" }) })] })] }), (0,jsx_runtime.jsxs)("div", { className: "task-preview", children: [(0,jsx_runtime.jsx)("p", { className: "task-description", children: task.description }), (0,jsx_runtime.jsxs)("div", { className: "task-meta", children: [(0,jsx_runtime.jsxs)("span", { className: "task-due-date", children: [t('tasks.task.due'), ": ", task.dueDate ? new Date(task.dueDate).toLocaleDateString() : t('tasks.task.noDueDate')] }), task.subtasks && task.subtasks.length > 0 && ((0,jsx_runtime.jsxs)("span", { className: "subtasks-count", children: [task.subtasks.length, " ", t('tasks.task.subtasksCount')] }))] }), (0,jsx_runtime.jsxs)("div", { className: "task-quick-actions", children: [(0,jsx_runtime.jsx)("select", { value: task.status, onChange: e => handleStatusChange(task.id, e.target.value), className: `task-status-dropdown status-${task.status}`, disabled: task.status === 'completed', title: t('tasks.task.changeStatus'), style: { minWidth: 120, borderRadius: 6, padding: '0.25rem 0.5rem', fontWeight: 500 }, children: statusOptions.map(opt => ((0,jsx_runtime.jsx)("option", { value: opt.value, children: opt.label }, opt.value))) }), task.status === 'completed' && ((0,jsx_runtime.jsx)("span", { className: "task-status-badge completed", style: { marginLeft: 8, color: '#10b981', fontWeight: 600 }, children: t('tasks.task.completedBadge') })), (0,jsx_runtime.jsxs)("button", { onClick: (e) => {
                                                            e.stopPropagation();
                                                            handleEditTask(task);
                                                        }, className: "btn-quick-action btn-edit", title: t('tasks.task.editTask'), children: ["\u270F\uFE0F ", t('tasks.task.edit')] })] })] }), expandedTaskId === task.id && ((0,jsx_runtime.jsxs)("div", { className: "task-expanded-details", children: [(0,jsx_runtime.jsxs)("div", { className: "task-details-section", children: [(0,jsx_runtime.jsxs)("div", { className: "task-info-grid", children: [(0,jsx_runtime.jsxs)("div", { className: "info-item", children: [(0,jsx_runtime.jsx)("span", { className: "info-label", children: t('tasks.task.priority') }), (0,jsx_runtime.jsx)("span", { className: `info-value priority ${task.priority}`, children: task.priority })] }), (0,jsx_runtime.jsxs)("div", { className: "info-item", children: [(0,jsx_runtime.jsx)("span", { className: "info-label", children: t('tasks.task.category') }), (0,jsx_runtime.jsx)("span", { className: "info-value", children: task.category })] }), task.estimatedHours && ((0,jsx_runtime.jsxs)("div", { className: "info-item", children: [(0,jsx_runtime.jsxs)("span", { className: "info-label", children: [t('tasks.task.estimatedHours'), ":"] }), (0,jsx_runtime.jsxs)("span", { className: "info-value", children: [task.estimatedHours, "h"] })] })), task.location && ((0,jsx_runtime.jsxs)("div", { className: "info-item", children: [(0,jsx_runtime.jsxs)("span", { className: "info-label", children: [t('tasks.task.location'), ":"] }), (0,jsx_runtime.jsx)("span", { className: "info-value", children: task.location })] }))] }), task.notes && ((0,jsx_runtime.jsxs)("div", { className: "task-notes", children: [(0,jsx_runtime.jsx)("h4", { children: t('tasks.task.notes') }), (0,jsx_runtime.jsx)("p", { children: task.notes })] })), task.tags && task.tags.length > 0 && ((0,jsx_runtime.jsxs)("div", { className: "task-tags", children: [(0,jsx_runtime.jsx)("h4", { children: t('tasks.task.tags') }), (0,jsx_runtime.jsx)("div", { className: "tags-list", children: task.tags.map((tag, index) => ((0,jsx_runtime.jsx)("span", { className: "tag", children: tag }, index))) })] })), task.assignedTeamMembers && task.assignedTeamMembers.length > 0 && ((0,jsx_runtime.jsxs)("div", { className: "task-team", children: [(0,jsx_runtime.jsx)("h4", { children: t('tasks.task.teamMembers') }), (0,jsx_runtime.jsx)("div", { className: "team-members-list", children: task.assignedTeamMembers.map((member, index) => ((0,jsx_runtime.jsxs)("div", { className: "team-member-item", children: [(0,jsx_runtime.jsxs)("div", { className: "member-info", children: [getMemberAvatar(member.userId), (0,jsx_runtime.jsxs)("div", { className: "member-details", children: [(0,jsx_runtime.jsx)("span", { className: "member-name", children: getMemberName(member.userId) }), (0,jsx_runtime.jsx)("span", { className: "member-role", children: member.role })] })] }), member.notes && (0,jsx_runtime.jsx)("span", { className: "member-notes", children: member.notes })] }, member.userId))) })] })), task.subtasks && task.subtasks.length > 0 && ((0,jsx_runtime.jsxs)("div", { className: "task-subtasks", children: [(0,jsx_runtime.jsxs)("h4", { children: [t('tasks.task.subtasks'), " (", task.subtasks.filter(st => st.status === 'completed').length, "/", task.subtasks.length, " ", t('tasks.task.subtasksCompleted'), ")"] }), (0,jsx_runtime.jsx)("div", { className: "subtasks-list", children: task.subtasks.map((subtask, index) => ((0,jsx_runtime.jsxs)("div", { className: "subtask-item", children: [(0,jsx_runtime.jsxs)("div", { className: "subtask-header", children: [(0,jsx_runtime.jsx)("h5", { children: subtask.title }), (0,jsx_runtime.jsx)("span", { className: `subtask-status ${subtask.status}`, children: subtask.status })] }), (0,jsx_runtime.jsx)("p", { className: "subtask-description", children: subtask.description }), (0,jsx_runtime.jsxs)("div", { className: "subtask-meta", children: [(0,jsx_runtime.jsxs)("span", { className: "subtask-due", children: [t('tasks.task.due'), ": ", subtask.dueDate ? new Date(subtask.dueDate).toLocaleDateString() : t('tasks.task.noDueDate')] }), subtask.estimatedHours && ((0,jsx_runtime.jsxs)("span", { className: "subtask-hours", children: [subtask.estimatedHours, "h"] }))] })] }, subtask.id))) })] }))] }), (0,jsx_runtime.jsxs)("div", { className: "task-comments-section", children: [(0,jsx_runtime.jsx)("h4", { children: "Comments" }), (0,jsx_runtime.jsx)("div", { className: "comments-list", children: task.comments && task.comments.length > 0 ? (task.comments.map((comment, index) => ((0,jsx_runtime.jsxs)("div", { className: "comment-item", children: [(0,jsx_runtime.jsxs)("div", { className: "comment-header", children: [(0,jsx_runtime.jsxs)("div", { className: "comment-author", children: [getMemberAvatar(comment.userId), (0,jsx_runtime.jsx)("span", { className: "author-name", children: getMemberName(comment.userId) })] }), (0,jsx_runtime.jsx)("span", { className: "comment-date", children: new Date(comment.createdAt).toLocaleString() })] }), (0,jsx_runtime.jsx)("p", { className: "comment-content", children: comment.content })] }, comment.id)))) : ((0,jsx_runtime.jsx)("p", { className: "no-comments", children: "No comments yet. Be the first to add one!" })) }), (0,jsx_runtime.jsxs)("div", { className: "add-comment", children: [(0,jsx_runtime.jsx)("textarea", { placeholder: "Add a comment...", value: newComment, onChange: (e) => setNewComment(e.target.value), className: "comment-input", rows: 3 }), (0,jsx_runtime.jsx)("div", { className: "comment-actions", children: (0,jsx_runtime.jsx)("button", { onClick: () => handleAddComment(task.id), disabled: !newComment.trim(), className: "btn-primary", children: t('tasks.addComment') }) })] })] }), (0,jsx_runtime.jsxs)("div", { className: "task-expanded-actions", children: [(0,jsx_runtime.jsx)("select", { value: task.status, onChange: e => handleStatusChange(task.id, e.target.value), className: `task-status-dropdown status-${task.status}`, disabled: task.status === 'completed', title: t('tasks.task.changeStatus'), style: { minWidth: 120, borderRadius: 6, padding: '0.25rem 0.5rem', fontWeight: 500 }, children: statusOptions.map(opt => ((0,jsx_runtime.jsx)("option", { value: opt.value, children: opt.label }, opt.value))) }), task.status === 'completed' && ((0,jsx_runtime.jsx)("span", { className: "task-status-badge completed", style: { marginLeft: 8, color: '#10b981', fontWeight: 600 }, children: t('tasks.task.completedBadge') })), (0,jsx_runtime.jsx)("button", { onClick: () => handleEditTask(task), className: "btn-secondary", children: t('tasks.editTask') }), (0,jsx_runtime.jsx)("button", { onClick: () => handleDeleteTask(task.id), className: "btn-danger", children: t('tasks.deleteTask') })] })] }))] }, task.id))) })) })), viewMode === 'calendar' && ((0,jsx_runtime.jsx)("div", { className: "calendar-view", children: (0,jsx_runtime.jsx)("p", { children: t('tasks.comingSoon.calendar') }) })), viewMode === 'kanban' && ((0,jsx_runtime.jsx)("div", { className: "kanban-board", children: (0,jsx_runtime.jsx)("p", { children: t('tasks.comingSoon.kanban') }) })), viewMode === 'analytics' && ((0,jsx_runtime.jsx)("div", { className: "analytics-view", children: (0,jsx_runtime.jsx)("p", { children: t('tasks.comingSoon.analytics') }) }))] }), showTaskForm && ((0,jsx_runtime.jsx)("div", { className: "modal-overlay", children: (0,jsx_runtime.jsxs)("div", { className: "modal-content", children: [(0,jsx_runtime.jsxs)("div", { className: "modal-header", children: [(0,jsx_runtime.jsx)("h2", { children: editingTask ? t('tasks.editTask') : t('tasks.taskForm.createTask') }), (0,jsx_runtime.jsx)("button", { onClick: () => {
                                        setShowTaskForm(false);
                                        setEditingTask(null);
...
const ScreenplayViewer_ScreenplayViewer = ({ screenplay, projectId, onClose, onGenerateReport }) => {
    ...
    const handleAddCollaborator = async (user) => {
        ...
        try {
            ...
            if (user.id) {
                await (0,index_esm/* addDoc */.gS)((0,index_esm/* collection */.rJ)(firebase.db, 'crewProfiles', user.id, 'notifications'), {
...
const CollaborationHub_CollaborationHub = ({ projectId }) => {
    ...
    const renderTasksTab = () => ((0,jsx_runtime.jsxs)("div", { className: "tasks-tab", children: [(0,jsx_runtime.jsxs)("div", { className: "tasks-header", children: [(0,jsx_runtime.jsx)("h2", { children: t('collaboration.tasksTab.title') }), (0,jsx_runtime.jsx)("p", { children: t('collaboration.tasksTab.subtitle') })] }), (0,jsx_runtime.jsx)("div", { className: "tasks-content", children: (0,jsx_runtime.jsx)(components_CollaborativeTasks_CollaborativeTasksHub, { projectId: projectId || 'default-project' }) })] }));
