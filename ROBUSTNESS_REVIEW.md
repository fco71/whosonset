...
10. **SUBSTANTIALLY RESOLVED 2026-06-14 — Rules tests.** `@firebase/rules-unit-testing` is wired into CI with thirteen behavioral tests covering notification authority, follow acceptance, mention fields and supervisor provenance, teacher-role escalation, profile publication privacy, message ownership, screenplay access/deletion, and scene-mark moderation. Add focused cases alongside future rule changes rather than relying on regex guards alone.
